...
public class NuevoProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelContenedor.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, -1, -1));

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel2.setText("Nombre Producto:");
        PanelContenedor.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));

        jLabel3.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel3.setText("Producto para que Especie:");
        PanelContenedor.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, -1, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel4.setText("Precio:");
        PanelContenedor.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 190, -1, -1));

        jLabel5.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel5.setText("Stock:");
        PanelContenedor.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 50, -1));

        jLabel6.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel6.setText("Descripcion:");
        PanelContenedor.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, -1, -1));
        ...
        PanelContenedor.add(txtNombreProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 190, -1));
        ...
        PanelContenedor.add(txtEspecieProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 110, -1));
        ...
        PanelContenedor.add(txtPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 190, 110, -1));
        PanelContenedor.add(spinnerStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 110, -1));

        txtDescripcion.setColumns(20);
        txtDescripcion.setRows(5);
        jScrollPane1.setViewportView(txtDescripcion);

        PanelContenedor.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, 230, -1));
        ...
        PanelContenedor.add(btnLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 380, 70, 50));
        ...
        PanelContenedor.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 380, 70, 50));

        labelErrorProducto.setForeground(new java.awt.Color(255, 0, 0));
        PanelContenedor.add(labelErrorProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 110, 20));

        labelErrorEspecie.setForeground(new java.awt.Color(255, 0, 0));
        PanelContenedor.add(labelErrorEspecie, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 150, 110, 20));

        labelErrorPrecio.setForeground(new java.awt.Color(255, 0, 0));
        PanelContenedor.add(labelErrorPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 110, 20));

        labelErrorStock.setForeground(new java.awt.Color(255, 0, 0));
        PanelContenedor.add(labelErrorStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 110, 20));
        ...
        PanelContenedor.add(btnAtras, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, 70, 90));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(PanelContenedor, javax.swing.GroupLayout.PREFERRED_SIZE, 480, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(PanelContenedor, javax.swing.GroupLayout.DEFAULT_SIZE, 445, Short.MAX_VALUE)
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if ( validarProducto() ) {
            ...
            controlLogica.crearProducto(nombre, especie, precio, stock, descripcion);
            ...
            mostrarMensaje("Producto ingresado correctamente!",
                    "Info", "Ingreso de Producto");
            
            /*Recargo la Lista de Productos*/
            /*Principal princi = new Principal();
            princi.cargarTablaProductos();*/
            /*Mejor recargo la Lista de Productos una vez vuelva ATRAS, la recargo
            ésa sola vez y listo, en vez de cada vez que cree un Nuevo Producto*/
        }
